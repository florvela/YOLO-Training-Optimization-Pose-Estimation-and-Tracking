...
# os.system(f"cd ../007-ByteTrack-and-YOLOv8-pose && source ./env/bin/activate && python3 tracking.py --video {cwd}/output/youtube_video4_trimmed_nbs.mp4 --output {cwd}/detection_on_removed_background/")
