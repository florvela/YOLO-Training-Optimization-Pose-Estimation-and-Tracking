...
def main():
    MODEL_NAME = "best"
    weights_dir = "/home/flor/Desktop/git_repos/YOLO-OpenVINO-TVM-GStreamer/002-Training-models/train_results/model_yolov8_tf_yolov8s_imgsz_800_epochs_78_batch_16_dataset_v2/weights/"

    images_path = "/home/flor/Desktop/git_repos/YOLO-OpenVINO-TVM-GStreamer/datasets/yolov8_original_no_empty/valid/images"
    yaml_path = "/home/flor/Desktop/git_repos/YOLO-OpenVINO-TVM-GStreamer/datasets/yolov8_original_no_empty/data.yaml"

    # model = YOLO(f"yolov8s.pt")
    model = YOLO(f"/home/flor/Desktop/git_repos/YOLO-OpenVINO-TVM-GStreamer/002-Training-models/train_results/model_yolov8_tf_yolov8s_imgsz_800_epochs_78_batch_16_dataset_v2/weights/{MODEL_NAME}.pt")
    args = get_cfg(cfg=DEFAULT_CFG)
    args.data = "/home/flor/Desktop/git_repos/YOLO-OpenVINO-TVM-GStreamer/datasets/yolov8_original_no_empty/data.yaml"
